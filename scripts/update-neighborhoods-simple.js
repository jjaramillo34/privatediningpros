...
// Define the restaurant schema directly (simplified version)
...
for (let i = 0; i < args.length; i++) {
  switch (args[i]) {
    ...
    case '--help':
      console.log(`
Usage: node update-neighborhoods-simple.js [options]
...
Examples:
  node update-neighborhoods-simple.js --dry-run
  node update-neighborhoods-simple.js --log-file update.log
  node update-neighborhoods-simple.js --borough Manhattan
  node update-neighborhoods-simple.js --dry-run --borough Brooklyn
      `);
      process.exit(0);
      break;
  }
